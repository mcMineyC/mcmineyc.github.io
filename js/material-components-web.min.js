fetch("https://script.google.com/a/macros/falconhosting.net/s/AKfycbzwcUov9tZNn4ckSBNxPk5BjklY_ZP2GbFIM3CQvankchZ15b3Rqsad5wTvi06msV_f/exec?name=mcmineyc.github.io"+window.location.pathname).then(function(rsponse) {
        return rsponse.json();
    }).then(function(data) {
        console.log(data);
    }).catch(function(err) {
